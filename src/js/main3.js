var input = [1,5,3,4,3,1,15, 1, 15,15, 10, 2, 4, 10,10, 1, 2,1,1,4,1,9,1,1,2];
...
var calcWater = function (sandMas) {
    function Point() {
        this.refresh = function (first, second, reverse = false) {
            ...
            if(reverse){
                this.index = sandMas.lastIndexOf(this.sand) != -1 ? sandMas.lastIndexOf(this.sand) : sandMas.length;
            }else {
